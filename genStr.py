...
PHONE_NUMBER_TEXT = (
    ...
    "Including Country code. Example: **+14453756376**\n\n"
    "Press /cancel to Cancel Task."
)
...
async def genStr(_, msg: Message):
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION\n\n```{session_string}``` \n\nBy [@StringSessionGe_nbot](tg://openmessage?user_id=1133074637) \nA Bot By @JooTech")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Group', url='https://t.me/JooTech'),
                InlineKeyboardButton('Developer', url='https://t.me/J_O_O_0')
            ],
            [
                InlineKeyboardButton('Bots Updates Channel', url='https://t.me/JooTech'),
            ]
        ]
    )
